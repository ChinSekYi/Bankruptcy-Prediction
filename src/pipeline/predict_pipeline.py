...
class CustomData: 
    ...
    def __init__(self,
        ...
        self.current_assets_short_term_liabilities = current_assets_short_term_liabilities
        ...
        self.book_value_of_equity_total_liabilities = book_value_of_equity_total_liabilities
        self.sales_total_assets = sales_total_assets
        self.equity_total_assets = equity_total_assets
        self.gross_profit_extraordinary_items_financial_expenses_total_assets = gross_profit_extraordinary_items_financial_expenses_total_assets
        ...
        self.total_liabilities_365_gross_profit_depreciation = total_liabilities_365_gross_profit_depreciation
        self.gross_profit_depreciation_total_liabilities = gross_profit_depreciation_total_liabilities
        ...
        self.profit_on_operating_activities_total_assets = profit_on_operating_activities_total_assets
        ...
        self.net_profit_depreciation_total_liabilities = net_profit_depreciation_total_liabilities
        self.profit_on_operating_activities_financial_expenses = profit_on_operating_activities_financial_expenses
        ...
        self.current_liabilities_365_cost_of_products_sold = current_liabilities_365_cost_of_products_sold
        self.operating_expenses_short_term_liabilities = operating_expenses_short_term_liabilities
        ...
        self.current_assets_inventories_long_term_liabilities = current_assets_inventories_long_term_liabilities
        self.constant_capital_total_assets = constant_capital_total_assets
        self.profit_on_sales_sales = profit_on_sales_sales
        self.current_assets_inventory_receivables_short_term_liabilities = current_assets_inventory_receivables_short_term_liabilities
        self.total_liabilities_profit_on_operating_activities_depreciation_12_365 = total_liabilities_profit_on_operating_activities_depreciation_12_365
        self.profit_on_operating_activities_sales = profit_on_operating_activities_sales
        self.rotation_receivables_inventory_turnover_days = rotation_receivables_inventory_turnover_days
        self.receivables_365_sales = receivables_365_sales
        self.net_profit_inventory = net_profit_inventory
        self.current_assets_inventory_short_term_liabilities = current_assets_inventory_short_term_liabilities
        self.inventory_365_cost_of_products_sold = inventory_365_cost_of_products_sold
        self.EBITDA_profit_on_operating_activities_depreciation_total_assets = EBITDA_profit_on_operating_activities_depreciation_total_assets
        self.EBITDA_profit_on_operating_activities_depreciation_sales = EBITDA_profit_on_operating_activities_depreciation_sales
        ...
        self.short_term_liabilities_365_cost_of_products_sold = short_term_liabilities_365_cost_of_products_sold
